...
**ANSWER:**
The most important part of code reviews is communication; if you can communicate why you are doing the things you're doing clearly and effectively, it makes all the difference when you are reviewing it. This includes commenting out of code, in talking about what is going on with the written code. I also appreciate when other people comment out simpler, clearer code amendments that refactors some of the inefficient code I have written.
...
**ANSWER:**
Containers could help by putting all the necessary dependencies inside that particular container and then do all the necessary work inside that container. With a service like Docker, you can create a container on their servers with al the necessary dependencies and just access that container when you want to do a specific task.
